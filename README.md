...
- **① 듀얼모멘텀**: 종합(복수 자산군) 듀얼모멘텀 방식. 미국주식/선진국주식/채권/리츠 등 여러 자산군을 각각 독립적으로 판단합니다. 자산군마다 후보종목 중 상대모멘텀 1위를 고르고, 그 종목의 12개월 수익률이 안전자산(BIL)보다 낮으면 그 자산군 비중만큼 안전자산으로 대피합니다. 자산군별 비중은 웹앱에서 자유롭게 설정할 수 있습니다.
